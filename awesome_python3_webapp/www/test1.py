...
import awesome_python3_webapp.www.orm, asyncio
from awesome_python3_webapp.www.Model import User, Blog, Comment
...
def test(loop):
	...
	yield from awesome_python3_webapp.www.orm.create_pool(loop = loop, user = 'www-data', password='www-data', db='awesome')
